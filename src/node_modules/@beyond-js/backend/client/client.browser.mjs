...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/backend@0.1.7/client"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./action/bridge', {hash: 1745530134, creator: function (require, exports) {
"use strict";
...
ims.set('./action/index', {hash: 501662521, creator: function (require, exports) {
"use strict";
