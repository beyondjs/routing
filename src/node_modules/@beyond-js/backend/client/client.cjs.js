...
exports.hmr = exports.backends = exports.__beyond_pkg = exports.Backend = exports.ActionsBridge = void 0;
...
__pkg.exports.process = function ({
  ...
  (require || prop === 'ActionsBridge') && (exports.ActionsBridge = ActionsBridge = require ? require('./action/bridge').ActionsBridge : value);
  (require || prop === 'Backend') && (exports.Backend = Backend = require ? require('./backend').Backend : value);
  (require || prop === 'backends') && (exports.backends = backends = require ? require('./backends').backends : value);
};
